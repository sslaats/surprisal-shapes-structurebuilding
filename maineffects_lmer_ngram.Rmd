...
``` {r load, echo=TRUE}
# load data 
data <- read.csv('r_data_wholebrain_ngram.csv', header = TRUE)
...
write_xlsx(list("td_bu_su_random" = cbind(rownames(as.data.frame(comparison1[1])), as.data.frame(comparison1[1])), 
                ...
                'K:/Project/Project 2 - MEG probabilistic syntax/audiobook/main-effects/wholebrain_modelcomp_stats.xlsx')
```